...
def helpmessage():
    ...
    helpMessage =   "[ Help Message ]" + "\n" + \
                    ...
                    " " + key + "SearchYoutube (Nama Video)" + "\n" + \
                    " " + key + "SearchMusic (Nama Lagu)" + "\n" + \
                    " " + key + "SearchLyric (Nama Lagu)" + "\n" + \
                    " " + key + "SearchImage (Nama gambar)" + "\n" + \
                    "[ Tim Aimbot ]"
    return helpMessage
...
# Pembatas Script #   
                                ...
                                if len(cond) == 1:
                                    ...
                                    ret_ += "\n\nUntuk Melihat Detail Lirik, silahkan gunakan command {}SearchLyric {}|「number」".format(str(setKey), str(search))
                                    client.sendMessage(to, str(ret_))
                                elif len(cond) == 2:
                                    num = int(cond[1])
